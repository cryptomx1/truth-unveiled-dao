    ...
    return (<div className="min-h-screen bg-slate-900 py-8">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          {/* Ballot Card */}
          <VerifiableBallotCard ballotId="test-ballot-001" ballotTitle="Test Civic Proposal: Community Resource Allocation" ballotOptions={mockBallotOptions} minimumTier="Citizen" minimumTrustScore={50} timeToLiveMinutes={10} allowVaultDerivation={true} onVoteSubmitted={handleVoteSubmitted} userHash="user-did:civic:commander-mark"/>
          
          {/* Submission History */}
          {submissionResults.length > 0 && (<div className="bg-slate-800 border border-slate-600 rounded-lg p-6">
              <h2 className="text-lg font-semibold text-slate-200 mb-4">
                Vote Submission History
              </h2>
              
              <div className="space-y-4">
                {submissionResults.map((result, index) => (<div key={index} className={`p-4 rounded-lg border ${result.success
                      ...
                      <div>
                        ...
                        <div className="space-y-1">
                          <div>
                            ...
                            <span className={`ml-2 font-medium ${result.success ? 'text-green-300' : 'text-red-300'}`}>

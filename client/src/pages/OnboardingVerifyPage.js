...
export const OnboardingVerifyPage = () => {
    const [verificationStep, setVerificationStep] = useState('pillar_check');
    ...
    const handleBadgeUnlock = (unlockedBadgeData) => {
    ...
    const renderStepContent = () => {
        switch (verificationStep) {
            ...
            <LightOfTruthBadge isUnlocked={true} size="large" showAnimation={true} badgeData={badgeData}/>
            
            <div className="text-center space-y-4">
              <Button onClick={handleExportBadge} disabled={exportInProgress} size="lg" className="min-w-64">
            ...
            <LightOfTruthBadge isUnlocked={true} size="medium" showAnimation={true} badgeData={badgeData}/>

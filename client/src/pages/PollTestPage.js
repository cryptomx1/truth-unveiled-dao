...
export default function PollTestPage() {
    ...
    return (<div className="min-h-screen bg-slate-900 p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card className="bg-slate-800 border-slate-700 text-white">
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={handleCreateTestPoll} className="w-full bg-blue-600 hover:bg-blue-700">
                Create Test Poll
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="bg-slate-800 border-slate-700 text-white">
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={handleAccessDeck10} className="w-full bg-purple-600 hover:bg-purple-700">
                Access Deck #10
              </Button>
            </CardContent>
          </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex space-x-2">
                <Button size="sm" onClick={() => window.location.href = '/command'} className="bg-slate-600 hover:bg-slate-500">
                  Command Center
                </Button>
                <Button size="sm" onClick={() => window.location.href = '/poll/analytics'} className="bg-slate-600 hover:bg-slate-500">
                  Poll Analytics
                </Button>
              </div>
            </div>

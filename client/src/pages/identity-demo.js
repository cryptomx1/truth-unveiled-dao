...
import { StreamDeckOverviewLayer, CivicMirrorSyncGrid, CivicSyncDiagnosticsPanel, KnowledgeAtlasPanel, DeckIndexNavigator, DeckDetailView, DeckMissionCard, DeckExportBundle } from '@/components/phase/overview';
...
export default function IdentityDemo() {
    return (<div className="min-h-screen dao-gradient-bg flex items-center justify-center p-4">
      <TTSManager />
      <div className="flex flex-col gap-6 items-center max-w-screen-sm mx-auto w-full">
        ...
        <div className="w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <RoleBasedOverlay config={{
            id: 'citizen_demo',
            requiredRole: 'Citizen',
            fallbackVisible: true,
            testingMode: true,
            emergencyOverride: false
        }} onAccessViolation={(violation) => console.log('Access violation:', violation)} onRenderEvent={(event) => console.log('Render event:', event)}>
              <div className="bg-slate-800 border border-slate-700 rounded-lg p-4">
                ...
                <UrgencyTag level="info" message="General information" overlayId="citizen_demo" testingMode={true}/>
              </div>
            </RoleBasedOverlay>
            ...
            emergencyOverride: false
              ...
              <div className="bg-slate-800 border border-slate-700 rounded-lg p-4">
                ...
                <UrgencyTag level="critical" message="High-level access" overlayId="governor_demo" testingMode={true}/>
              </div>
            </RoleBasedOverlay>
          </div>
          ...
          {/* Audit Trail */}
          <div className="mb-6">
            <OverlayAuditTrail maxEvents={20} autoRefresh={true} showZkpDetails={true} onAuditEvent={(event) => console.log('Audit event:', event)}/>
          </div>
        </div>
        ...
        <div className="w-full">
          <ProposalSubmission userDID="did:civic:0x7f3e2d1a8c9b5f2e" userTier="Citizen" onSubmissionComplete={(proposal) => {
        ...
        <div className="w-full max-w-lg">
          <CivicConstellationExplorer userTier="citizen" initialZoom={1.0} onClusterFocus={(clusterId) => console.log('Focus:', clusterId)} onDeckHover={(deckId) => console.log('Hover:', deckId)} className="mx-auto"/>
        </div>

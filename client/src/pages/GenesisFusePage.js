...
import { Zap, Archive, Download, Shield, Sparkles, Database, Hash } from 'lucide-react';
import GenesisBadgeBinder from '@/components/genesis/GenesisBadgeBinder';
import { legacyVaultExporter } from '@/vault/LegacyVaultExporter';
const GenesisFusePage = () => {
    ...
    const [cidSnapshot, setCidSnapshot] = useState(null);
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="vault" className="space-y-6">
            <Card className="w-full bg-white dark:bg-slate-900">
              ...
              <CardContent className="space-y-6">
                <div className="flex justify-center">
                  <Button onClick={handleCreateVaultSnapshot} className="px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700">
                    <Database className="h-4 w-4 mr-2"/>
                    Create Vault Snapshot
                  </Button>
                </div>

                {vaultSnapshot && (<div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-slate-800 dark:to-slate-700 rounded-lg p-6 border-2 border-blue-200 dark:border-blue-700">
          ...
          <TabsContent value="legacy" className="space-y-6">
            <Card className="w-full bg-white dark:bg-slate-900">
              ...
              <CardContent className="space-y-6">
                <div className="flex justify-center">
                  <Button onClick={handleCreateLegacyArchive} className="px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700">
                    <Archive className="h-4 w-4 mr-2"/>
                    Create Legacy Archive (90 days)
                  </Button>
                </div>

                {legacyArchive && (<div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-slate-800 dark:to-slate-700 rounded-lg p-6 border-2 border-green-200 dark:border-green-700">
                    <h3 className="text-lg font-medium text-slate-900 dark:text-slate-100 mb-4">
          ...
          <TabsContent value="cid" className="space-y-6">
            <Card className="w-full bg-white dark:bg-slate-900">
              ...
              <CardContent className="space-y-6">
                <div className="flex justify-center">
                  <Button onClick={handleGenerateCIDSnapshot} className="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700">
                    <Hash className="h-4 w-4 mr-2"/>
                    Generate CID Snapshot
                  </Button>
                </div>

                {cidSnapshot && (<div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-slate-800 dark:to-slate-700 rounded-lg p-6 border-2 border-purple-200 dark:border-purple-700">
                    <h3 className="text-lg font-medium text-slate-900 dark:text-slate-100 mb-4">

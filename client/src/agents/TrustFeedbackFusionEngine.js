...
export class TrustFeedbackFusionEngine {
    ...
    getCrossDeckInfluence(sourceDeck, targetDeck) {
        const influence = this.crossDeckInfluences.find(inf => inf.sourcedeckId === sourceDeck && inf.targetDeckId === targetDeck);
...
if (typeof window !== 'undefined') {
    window.trustFusionEngine = TrustFeedbackFusionEngine.getInstance();
}

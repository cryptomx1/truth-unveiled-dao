 ...
 */
export function getTierForCID(cidDigest) {
 ...
 */
export function validateCIDAccess(cidDigest, route) {
 ...
 */
export function getAccessibleRoutes(cidDigest) {
    const userTier = getTierForCID(cidDigest);
 ...
 */
export function createCIDAccessConfig(cidDigest) {
...
export const CIDTierMapUtils = {
     ...
     */
    getAllTiers: () => Object.values(CIDTier),
    /**
     * Gets all mock CID mappings for testing
     */
    getMockMappings: () => ({ ...mockCIDTierMapping }),
    /**
     * Adds a mock CID mapping for testing
     */
    addMockMapping: (cidDigest, tier) => {

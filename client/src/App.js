...
function Router() {
    return (<Switch>
      ...
      <Route path="/press/rep-dissonance" component={() => (<div className="container mx-auto px-4 py-8">
          <RepDissonanceEngine />
        </div>)}/>
      ...
      <Route path="/global/deployment" component={() => (<div className="container mx-auto px-4 py-8">
          <GlobalDeploymentDashboard />
        </div>)}/>
      <Route path="/global/deploy" component={() => (<div className="container mx-auto px-4 py-8">
          <CivicDeploymentWizard />
        </div>)}/>
      <Route path="/global/broadcast-test" component={() => (<div className="container mx-auto px-4 py-8">
          <RegionalBroadcastTest />
        </div>)}/>
      {/* Federation Routes - Phase X-FED Step 1 & 2 */}
      <Route path="/federation/activate" component={() => (<div className="container mx-auto px-4 py-8">
          <FederationActivationWizard />
        </div>)}/>
      <Route path="/federation/proposal/submit" component={() => (<div className="container mx-auto px-4 py-8">
          <FederationRouter />
        </div>)}/>
      <Route path="/federation/proposal/review/:id?" component={() => (<div className="container mx-auto px-4 py-8">
          <FederationRouter />
        </div>)}/>
      <Route path="/federation/proposal/vote/:id?" component={() => (<div className="container mx-auto px-4 py-8">
          <FederationRouter />
        </div>)}/>
      <Route path="/federation/proposal/audit/:id?" component={() => (<div className="container mx-auto px-4 py-8">
          <FederationRouter />
        </div>)}/>
      ...
      <Route path="/wallet/treasury" component={() => (<div className="container mx-auto px-4 py-8">
          <TPDisbursementCard />
        </div>)}/>
      ...
      <Route path="/wallet/staking" component={() => (<div className="container mx-auto px-4 py-8">
      ...
      <Route path="/tts-test" component={() => (<div className="container mx-auto px-4 py-8">
          <TTSTestCard />
        </div>)}/>
      ...
      <Route path="/tts/settings" component={() => (<div className="container mx-auto px-4 py-8">
          <div className="text-center py-8">
      ...
      <Route path="/feedback/monitor" component={() => (<div className="container mx-auto px-4 py-8">
      ...
      <Route path="/unlock/guardian" component={() => (<div className="container mx-auto px-4 py-8">
          <CivicUnlockPortal />
        </div>)}/>
      {/* Municipal Policy Registry Route - Phase X-MUNICIPALPREP Step 4 */}
      <Route path="/municipal/registry" component={() => (<div className="container mx-auto px-4 py-8">
      ...
      <Route path="/streams/dashboard" component={() => (<div className="min-h-screen bg-background">
          <Suspense fallback={<div className="text-center py-8">Loading Stream Dashboard...</div>}>
            <StreamDashboard />
          </Suspense>
        </div>)}/>
      <Route path="/streams" component={() => (<div className="container mx-auto px-4 py-8">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border">
                ...
                <div className="mt-4">
                  <button onClick={() => {
                const router = window.civicAgentSystem?.zebecTreasuryRouter;
                if (router) {
      ...
      <Route path="/streams/dashboard" component={() => (<div className="container mx-auto px-4 py-8">
      ...
      <Route path="/federation" component={() => (<div className="container mx-auto px-4 py-8">
          <FederationRouter />
        </div>)}/>

      <Route path="/onboarding-required" component={() => (<div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
          <div className="bg-slate-800 border border-slate-700 rounded-lg p-8 max-w-md w-full text-center">
            ...
            <button onClick={() => window.location.href = '/identity-onboarding'} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium transition-colors w-full" aria-label="Start onboarding process">
              Start Onboarding
            </button>
          </div>
        </div>)}/>

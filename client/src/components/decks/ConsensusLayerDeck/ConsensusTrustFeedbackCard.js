...
export const ConsensusTrustFeedbackCard = ({ activeProposals = 4, consensusThreshold = 67, participantCount = 127 }) => {
    ...
    return (<div className="max-w-md mx-auto bg-slate-800 border border-slate-700 rounded-lg p-4">
      ...
      <div className="mb-4">
        <SentimentAggregationCard deckId="consensus_layer" deckName="Consensus Mechanisms Trust"/>
      </div>

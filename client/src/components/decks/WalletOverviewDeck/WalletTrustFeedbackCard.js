...
export const WalletTrustFeedbackCard = ({ walletAddress = "0x742d35c6da25ec13...c3a8", userDID = "did:civic:user123" }) => {
    ...
    return (<div className="max-w-md mx-auto bg-slate-800 border border-slate-700 rounded-lg p-4">
      ...
      <div className="mb-4">
        <SentimentAggregationCard deckId="wallet_overview" deckName="Wallet Operations Trust"/>
      </div>

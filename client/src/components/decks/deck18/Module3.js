...
export const Deck18Module3 = ({ moduleId = 'automation-workflows', automationLevel = 'advanced' }) => {
    const { isAuthenticated, cidStatus, validateCID } = useCIDAuthentication();
    if (!isAuthenticated) {
        return (<CIDAuthenticationGate onValidate={validateCID} title="Automation Workflows Access" description="Access to automation workflow management requires CID authentication for security purposes."/>);
    }
    ...
    return (<div className="w-full space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {activeWorkflows.map((workflow) => (<Card key={workflow.id} className="border border-gray-200 dark:border-gray-700">
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {automationCategories.map((category, index) => (<div key={index} className="space-y-2">

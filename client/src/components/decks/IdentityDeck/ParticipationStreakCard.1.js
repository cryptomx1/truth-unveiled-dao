...
export const ParticipationStreakOverview = ({ streak = MOCK_STREAK, className }) => {
    ...
    return (<div className={cn('bg-slate-800 border border-slate-700 rounded-xl p-6 shadow-xl max-h-[600px] w-full', className)} role="region" aria-label="Participation Streak Overview" data-testid="participation-streak-overview">
      {/* Header */}

...
export const Deck9Module1 = ({ moduleId = 'innovation-proposals', proposalType = 'community' }) => {
    ...
    return (<div className="w-full space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {proposals.map((proposal) => (<Card key={proposal.id} className={`border cursor-pointer transition-all ${selectedProposal === proposal.id ? 'border-yellow-500 bg-yellow-50 dark:bg-yellow-900/20' : 'border-gray-200 dark:border-gray-700'}`} onClick={() => handleProposalSelect(proposal.id)}>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {innovationCategories.map((category, index) => (<div key={index} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded">

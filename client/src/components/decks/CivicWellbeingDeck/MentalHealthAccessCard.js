...
import { AlertTriangle, Clock, Heart, Users, Phone, Calendar, MapPin, Sparkles } from "lucide-react";
const mockProviders = [
    {
        id: "provider_001",
...
export default function MentalHealthAccessCard() {
    ...
    const handleRequestAccess = async () => {
        ...
        const requestSuccess = provider.availability === "available" ||
            ...
            requestType === "emergency";
        const priority = requestType === "emergency" ? "critical" :
            requestType === "consultation" ? "high" :
                requestType === "referral" ? "medium" : "low";
        const status = requestType === "emergency" && provider.type === "crisis_center" ? "approved" :
    ...
    return (<Card className="w-full max-w-md mx-auto h-[600px] bg-slate-800 border-slate-700 text-white">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Select value={selectedProvider} onValueChange={setSelectedProvider}>
            ...
            <SelectContent className="bg-slate-700 border-slate-600">
              {availableProviders.map(provider => (<SelectItem key={provider.id} value={provider.id} className="text-white hover:bg-slate-600">
        ...
        {/* Provider Details */}
        {selectedProviderData && (<div className="space-y-2">
        ...
        {/* Request Access */}
        <div className="space-y-2">
          <Button onClick={handleRequestAccess} disabled={!canRequest} className="w-full h-10 bg-pink-600 hover:bg-pink-700 disabled:bg-slate-600" aria-label="Request access">
            {isRequesting ? (<>
          ...
          {!canRequest && !isRequesting && (<div className="text-xs text-amber-400 text-center" role="alert" aria-live="polite">
        ...
        <div className="space-y-2">
          ...
          <ScrollArea className="h-32">
            ...
            return (<div key={request.id} className="p-2 rounded-md bg-slate-700/50 border border-slate-600">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                    ...
                    <div className="mt-1 text-xs text-slate-300">
                      ...
                      {request.estimatedWait > 0 && (<div className="text-slate-500">
        ...
        {/* Accessibility Alert */}
        {accessibilityAlert && (<div className="p-2 bg-red-900/50 border border-red-600 rounded-md animate-pulse" role="alert" aria-live="polite">
            <div className="flex items-center gap-2">

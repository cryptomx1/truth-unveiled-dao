...
const FederationProposalAudit = ({ proposalId = 'fed_prop_001' }) => {
    ...
    const [badgeVerifications] = useState([
        {
    ...
    return (<div className="w-full max-w-6xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {Object.entries(finalResults.votingResults).map(([option, data]) => (<div key={option} className="flex justify-between items-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="bg-slate-900/50 dark:bg-slate-950/50 border-slate-700">
          ...
          <CardContent>
            <div className="space-y-4">
              {auditTrail.map((entry, index) => (<div key={index} className="bg-slate-800/50 rounded-lg p-4">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <div className="flex items-center gap-2">
                      {entry.verified ? (<Shield className="h-4 w-4 text-green-400"/>) : (<AlertTriangle className="h-4 w-4 text-yellow-400"/>)}
        ...
        <Card className="bg-slate-900/50 dark:bg-slate-950/50 border-slate-700">
          ...
          <CardContent>
            <div className="space-y-4">
              {badgeVerifications.map((badge, index) => (<div key={index} className="bg-slate-800/50 rounded-lg p-4">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                    ...
                    <Badge variant="outline" className={badge.verificationStatus === 'verified'
                ? 'text-green-400 border-green-400'
                : 'text-yellow-400 border-yellow-400'}>
                      {badge.verificationStatus === 'verified' ? (<CheckCircle className="h-3 w-3 mr-1"/>) : (<AlertTriangle className="h-3 w-3 mr-1"/>)}
                  ...
                  <Button variant="outline" size="sm" className="mt-3 border-slate-600 text-slate-200" onClick={() => window.open(`https://gateway.pinata.cloud/ipfs/${badge.cidLink}`, '_blank')}>
      ...
      <Card className="bg-slate-900/50 dark:bg-slate-950/50 border-slate-700">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Button onClick={exportAuditReport} disabled={exportInProgress} className="bg-blue-600 hover:bg-blue-700">
              {exportInProgress ? (<>
            ...
            <Button variant="outline" className="border-slate-600 text-slate-200" onClick={() => window.open('/federation/activate', '_blank')}>
              <Users className="h-4 w-4 mr-2"/>
              Federation Dashboard
            </Button>
            
            <Button variant="outline" className="border-slate-600 text-slate-200" onClick={() => console.log('📊 Publishing to DAO network...')}>

...
export class LLMPromptEmitter {
    ...
    generateLocalFallback(context, processingTime) {
    ...
    async generateCampaignMessage(request) {
    ...
    async generateBatchMessages(requests) {

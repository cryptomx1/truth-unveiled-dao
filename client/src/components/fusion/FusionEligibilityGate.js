...
import { TPVaultVerifier } from '@/services/TPVaultVerifier';
import ZKPUserMintExtension from '@/components/zkp/ZKPUserMintExtension';
export const FusionEligibilityGate = () => {
    ...
    if (showMintInterface && vaultData?.fusionEligible) {
        ...
        <Card>
          <CardContent className="p-4">
            <Button variant="ghost" onClick={() => setShowMintInterface(false)} className="text-blue-600 hover:text-blue-800">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <Progress value={(vaultData.truthPoints / FUSION_THRESHOLD) * 100} className="h-3"/>
      ...
      <Card>
        <CardContent className="p-6 text-center space-y-4">
          {vaultData.fusionEligible ? (<>
              ...
              <Button onClick={checkEligibilityAndProceed} disabled={checkingEligibility} size="lg" className="min-w-48">
              ...
              <div className="text-gray-600 p-4 bg-amber-50 dark:bg-amber-900 rounded-lg" role="alert" aria-live="polite">
              ...
              <div className="flex justify-center gap-4">
                <Button variant="outline" onClick={() => window.location.href = '/onboarding/verify'} className="min-w-40">
                  🏛️ Complete Pillars
                </Button>
                <Button variant="outline" onClick={() => window.location.href = '/deck/governance'} className="min-w-40">
          ...
          <div className="pt-4 border-t">
            <Button variant="ghost" onClick={() => window.location.href = '/fusion/dashboard'} className="text-sm">

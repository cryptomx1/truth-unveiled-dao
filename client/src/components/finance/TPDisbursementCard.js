...
import { DollarSign, TrendingUp, Users, Award, HelpCircle, ExternalLink } from "lucide-react";
export function TPDisbursementCard() {
    const [disbursementPool] = useState({
    ...
    return (<Card aria-label="TruthPoint Treasury Access">
      <CardHeader>
      ...
      <CardContent>
        <div className="space-y-6">
          ...
          {/* Claimable Balance */}
          {disbursementPool.claimable > 0 && (<div className="p-4 bg-green-50 border border-green-200 rounded-lg">
          ...
          <div>
              ...
              <Dialog>
                ...
                <DialogContent className="max-w-2xl">
                  ...
                  <div className="space-y-4 max-h-96 overflow-y-auto">
                    {earningRoutes.map((route) => (<div key={route.id} className="p-4 border rounded-lg">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <Button size="sm" variant="outline" onClick={() => window.location.href = route.deckRoute}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {earningRoutes.slice(0, 4).map((route) => (<div key={route.id} className="p-3 border rounded-lg hover:border-gray-300 transition-colors cursor-pointer" onClick={() => window.location.href = route.deckRoute}>
          ...
          <div className="pt-4 border-t">
            <Button variant="outline" size="sm" className="w-full" onClick={() => window.location.href = '/treasury'}>

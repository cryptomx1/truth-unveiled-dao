...
const TruthGenesisBadge = ({ badgeData, onExportReady }) => {
    const [badgeGenerated, setBadgeGenerated] = useState(false);
    const [animatingGuardian, setAnimatingGuardian] = useState(null);
    useEffect(() => {
    ...
    const getGuardianIcon = (guardian) => {
        const guardianIcons = {
            'Athena': '🦉',
            'Artemis': '🏹',
            'Sophia': '📚',
        ...
        return guardianIcons[guardian] || '🛡️';
    };
      ...
      <Card className="border-2 border-purple-500 bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            return (<div key={pillar} className={`p-2 bg-white dark:bg-gray-800 border rounded-lg text-center transition-all duration-300 ${isAnimating ? 'border-purple-500 bg-purple-50 dark:bg-purple-900/30 scale-105' : 'border-gray-200 dark:border-gray-700'}`}>
          ...
          <div className="text-center">
            <Badge className={`px-4 py-2 ${badgeGenerated

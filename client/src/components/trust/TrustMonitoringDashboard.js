...
import { AlertTriangle, Activity, TrendingUp, Shield, Clock, BarChart3, RefreshCw, Bell, Radio } from 'lucide-react';
...
export const TrustMonitoringDashboard = () => {
    const [alerts, setAlerts] = useState([]);
    const [monitoringMetrics, setMonitoringMetrics] = useState(null);
    const [deckMetrics, setDeckMetrics] = useState([]);
    ...
    return (<div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <TTSToggle deckId="trust_monitoring" moduleId="dashboard" content={dashboardContent} size="sm" variant="outline"/>
          <Button onClick={loadDashboardData} disabled={isRefreshing} size="sm" variant="outline">
      ...
      <Tabs defaultValue="alerts" className="space-y-4">
          ...
          <Card>
            ...
            <CardContent>
              {alerts.length === 0 ? (<div className="text-center py-8">
                  ...
                  {alerts.slice(0, 10).map((alert) => (<div key={alert.id} className={`p-3 rounded-lg border cursor-pointer hover:bg-muted/50 ${getSeverityColor(alert.severity)}`} onClick={() => setSelectedAlert(alert)}>
                        ...
                        <div className="flex items-start gap-2">
                          ...
                          <div className="space-y-1">
                            ...
                            <div className="flex items-center gap-3 text-xs text-muted-foreground">
                              ...
                              {alert.broadcastRequired && (<Badge variant="destructive" className="text-xs">
        ...
        <TabsContent value="decks" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {deckMetrics.map((deck) => (<Card key={deck.deckId}>
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                      {deck.volatilityFlag && (<AlertTriangle className="h-4 w-4 text-orange-600"/>)}
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Progress value={Math.max(0, Math.min(100, (deck.netSentiment + 100) / 2))} className="h-2"/>
                  </div>
        ...
        <TabsContent value="orchestration" className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-4">
              {orchestrationMetrics && (<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <TabsContent value="simulation" className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {simulationStatus && (<div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      <span>Progress</span>
            ...
            await loadDashboardData();
                      ...
                      <div className="grid grid-cols-3 gap-1">
                        <Button size="sm" variant="outline" onClick={() => fusionOrchestrator.syncWithDeck1()} className="text-xs">
                          Sync #1
                        </Button>
                        <Button size="sm" variant="outline" onClick={() => fusionOrchestrator.syncWithDeck10()} className="text-xs">
                          Sync #10
                        </Button>
                        <Button size="sm" variant="outline" onClick={() => fusionOrchestrator.syncWithTreasury()} className="text-xs">
                          Treasury
                        </Button>
                      </div>
                    </div>

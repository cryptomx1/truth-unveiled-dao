...
export const InfluenceDynamic = ({ userId = 'current-user', onInfluenceUpdate }) => {
    ...
    return (<Card className="w-full">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2">
            {metrics.recentActivity.map((activity, index) => (<div key={index} className="flex justify-between items-center p-2 bg-gray-50 dark:bg-gray-800 rounded">
                <div>
        ...
        <div className="flex gap-2">
          <Button onClick={handleRecalculate} variant="outline" className="flex-1" disabled={isLoading}>

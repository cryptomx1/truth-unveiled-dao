...
const ZKTierBadgeCard = () => {
    ...
    if (isLoading) {
        return (<Card className="w-full max-w-md mx-auto bg-slate-800 border-slate-700">
    ...
    return (<Card className="w-full max-w-md mx-auto bg-slate-800 border-slate-700">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex flex-col items-center space-y-4">
          <div className={`w-24 h-24 rounded-full bg-gradient-to-br ${getTierColor(badge.tier)} flex items-center justify-center shadow-lg`} role="img" aria-label={`${badge.tier} tier badge`}>
        ...
        {/* Export Button */}
        <Button onClick={exportBadge} disabled={isExporting} className="w-full bg-blue-600 hover:bg-blue-700 text-white" aria-label="Export badge as JSON file">

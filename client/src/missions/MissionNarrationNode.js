...
export class MissionNarrationNode {
    ...
    announceUnlockSuccess(missionId, missionTitle, unlockMethod, userId) {
    ...
    announceUnlockBlocked(missionId, missionTitle, blockers, userId) {
    ...
    announceReplayRequired(missionId, missionTitle, prerequisiteMission, userId) {
    ...
    announceTierInsufficient(missionId, missionTitle, requiredTier, currentTier, userId) {
    ...
    announceTrustInsufficient(missionId, missionTitle, requiredScore, currentScore, userId) {
    ...
    announceFeedbackRequired(missionId, missionTitle, requiresFeedback, requiresVote, userId) {
    ...
    explainEligibility(eligibility, missionTitle, userId) {
    ...
    provideNextStepsGuidance(missionId, missionTitle, nextSteps, userId) {
    ...
    clarifyRequirement(missionId, missionTitle, requirementType, explanation, userId) {
    ...
    formatUnlockMethod(unlockMethod) {
        switch (unlockMethod) {
    ...
    getNarrationHistory(userId, limit) {
...
export const announceUnlockSuccess = (missionId, missionTitle, unlockMethod, userId) => {
...
export const announceUnlockBlocked = (missionId, missionTitle, blockers, userId) => {
    const narrator = MissionNarrationNode.getInstance();
    return narrator.announceUnlockBlocked(missionId, missionTitle, blockers, userId);
};
export const announceReplayRequired = (missionId, missionTitle, prerequisiteMission, userId) => {
    const narrator = MissionNarrationNode.getInstance();
    return narrator.announceReplayRequired(missionId, missionTitle, prerequisiteMission, userId);
};
export const announceTierInsufficient = (missionId, missionTitle, requiredTier, currentTier, userId) => {
    const narrator = MissionNarrationNode.getInstance();
    return narrator.announceTierInsufficient(missionId, missionTitle, requiredTier, currentTier, userId);
};
export const announceTrustInsufficient = (missionId, missionTitle, requiredScore, currentScore, userId) => {
    const narrator = MissionNarrationNode.getInstance();
    return narrator.announceTrustInsufficient(missionId, missionTitle, requiredScore, currentScore, userId);
};
export const announceFeedbackRequired = (missionId, missionTitle, requiresFeedback, requiresVote, userId) => {
    const narrator = MissionNarrationNode.getInstance();
    return narrator.announceFeedbackRequired(missionId, missionTitle, requiresFeedback, requiresVote, userId);
};
export const explainEligibility = (eligibility, missionTitle, userId) => {
    const narrator = MissionNarrationNode.getInstance();

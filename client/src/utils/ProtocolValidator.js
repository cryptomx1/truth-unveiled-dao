...
export class ProtocolValidator {
    ...
    validateEightPillars() {
        ...
        const readyCount = pillars.filter(p => p.status === 'SWIPE_COMPLETE' || p.status === 'MODULE_LOCKED' || p.status === 'ANCHOR_READY').length;

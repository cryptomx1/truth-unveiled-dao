...
export class LLMAgentCore {
     ...
     */
    static async makeLLMRequest(request) {
     ...
     */
    static async analyzeForHallucinations(content, moduleSpecs) {
...
Respond with: CLEAN if no issues found, or ISSUES_DETECTED with specific concerns.`;
     ...
     */
    static async generateAuditSummary(auditData) {
...
Keep response under 200 words and focus on actionable insights.`;
     ...
     */
    static async classifyAPIError(errorLog, endpoint) {
